...
public class OrangeHRM_Navigation_Example {
...
@Test
	...
	public void Sign_On() throws InterruptedException
		
		{
	        ...
	        driver.findElementByLinkText("Leave").click();
	        driver.navigate().back();
	        //Add Verification Point here
	        Thread.sleep(4000);
	        driver.navigate().forward();
	        //Add Verification Point here
			//driver.close();//Close will close only current chrome browser
	        driver.quit();//It will close all the browser opened by Selenium
		}
